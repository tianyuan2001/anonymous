...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/SunLight/Turning_t05_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-48.163212, y=-102.922791, z=0.450000), carla.Rotation(pitch=0.000000, yaw=-94.314819, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=-133.158722, y=-142.372116, z=0.600000), carla.Rotation(pitch=0.000000, yaw=-179.557465, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    weather.sun_azimuth_angle = 40 # noisy
    for pd in pds:
        for alt in alts:
