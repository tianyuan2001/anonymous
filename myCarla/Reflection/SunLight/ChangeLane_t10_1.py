...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/SunLight/ChangeLane_t10_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-48.674351, y=36.955273, z=0.600000), carla.Rotation(pitch=0.000000, yaw=89.838760, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=-52.073921, y=120.189049, z=0.600000), carla.Rotation(pitch=0.000000, yaw=89.838760, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    weather.sun_azimuth_angle = 270 # noisy
    for pd in pds:
        for alt in alts:
