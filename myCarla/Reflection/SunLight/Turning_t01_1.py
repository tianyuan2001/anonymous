...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/SunLight/Turning_t01_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_end_point = carla.Transform(carla.Location(x=322.790924, y=-2.114089, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-179.999939, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    weather.sun_azimuth_angle = 60 # noisy
    for pd in pds:
        for alt in alts:
