...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/SunLight/Bend_t04_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-99.570290, y=-3.670201, z=9.771310), carla.Rotation(pitch=-0.124023, yaw=-143.667099, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=-16.246214, y=-47.019104, z=0.281942), carla.Rotation(pitch=0.000000, yaw=89.775162, roll=0.000000))
        print(ts_end_point)
