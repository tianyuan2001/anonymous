...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/SunLight/ChangeLane_t03_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=5.430785, y=122.276344, z=0.275307),carla.Rotation(pitch=0.000000, yaw=-90.362541, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=1.426758, y=47.210876, z=0.275307), carla.Rotation(pitch=0.000000, yaw=-88.891235, roll=0.000000))
        print(ts_end_point)
