...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/SunLight/StraightAhead_t02_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=59.710030, y=241.279999, z=0.500000), carla.Rotation(pitch=0.000000, yaw=-0.000183, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=151.300018, y=241.280029, z=0.500000), carla.Rotation(pitch=0.000000, yaw=-0.000183, roll=0.000000))
        print(ts_end_point)
