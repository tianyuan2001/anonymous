...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/SunLight/Bend_t06_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=93.267799, y=131.879639, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-13.571308, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=183.236069, y=86.662941, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-36.711231, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    weather.sun_azimuth_angle = 150 # noisy
    for pd in pds:
        for alt in alts:
