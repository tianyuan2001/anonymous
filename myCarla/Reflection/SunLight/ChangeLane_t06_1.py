...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/SunLight/ChangeLane_t06_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=166.004471, y=48.760906, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-0.053955, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=262.192596, y=41.848869, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-0.027893, roll=0.000000))
        print(ts_end_point)
