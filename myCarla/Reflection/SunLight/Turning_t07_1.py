...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/SunLight/Turning_t07_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-202.534286, y=58.544502, z=0.300000), carla.Rotation(pitch=0.000000, yaw=90.468849, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=-172.885178, y=111.686180, z=0.300000), carla.Rotation(pitch=0.000000, yaw=6.127446, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    '''weather.sun_azimuth_angle = 230 # noisy
    for pd in pds:
        for alt in alts:
