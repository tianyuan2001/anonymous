...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/SunLight/StraightAhead_t01_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=321.752045, y=194.732498, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-179.999939, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=212.642303, y=194.772919, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-179.999939, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    weather.sun_azimuth_angle = 0.0 # noisy
    for pd in pds:
        for alt in alts:
