...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/SunLight/StraightAhead_t03_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=4.104583, y=-46.115955, z=0.275307), carla.Rotation(pitch=0.000000, yaw=-88.586418, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=6.640107, y=-156.768860, z=0.275307), carla.Rotation(pitch=0.000000, yaw=-88.586418, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    weather.sun_azimuth_angle = 90 # noisy
    for pd in pds:
        for alt in alts:
