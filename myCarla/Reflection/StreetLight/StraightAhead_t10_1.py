...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/StreetLight/StraightAhead_t10_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-25.516296, y=24.613134, z=0.600000), carla.Rotation(pitch=0.000000, yaw=0.159198, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=77.008102, y=24.849667, z=0.600000), carla.Rotation(pitch=0.000000, yaw=0.159198, roll=0.000000))
        print(ts_end_point)
