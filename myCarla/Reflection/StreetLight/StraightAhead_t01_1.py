...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/StreetLight/StraightAhead_t01_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=395.959991, y=249.429993, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-90.000298, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=395.959991, y=105.389999, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-90.000298, roll=0.000000))
        print(ts_end_point)
