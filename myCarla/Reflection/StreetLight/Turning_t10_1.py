...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Reflection/StreetLight/Turning_t10_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-71.269684, y=132.314896, z=0.600000), carla.Rotation(pitch=0.000000, yaw=-167.127060, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=-106.686729, y=-4.847458, z=0.600000), carla.Rotation(pitch=0.000000, yaw=-89.357758, roll=0.000000))
        print(ts_end_point)
