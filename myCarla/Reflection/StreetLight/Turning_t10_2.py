...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/StreetLight/Turning_t10_2')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-52.133560, y=-40.180298, z=0.600000), carla.Rotation(pitch=0.000000, yaw=90.432304, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=-87.623032, y=12.967159, z=0.600000), carla.Rotation(pitch=0.000000, yaw=-179.840790, roll=0.000000))
        print(ts_end_point)
