...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/StreetLight/StraightAhead_t10_2')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-52.186737, y=42.565125, z=0.600000), carla.Rotation(pitch=0.000000, yaw=89.838760, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=-52.073921, y=114.189049, z=0.600000), carla.Rotation(pitch=0.000000, yaw=89.838760, roll=0.000000))
        print(ts_end_point)
