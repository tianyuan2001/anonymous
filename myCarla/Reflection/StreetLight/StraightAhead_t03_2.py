...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Reflection/StreetLight/StraightAhead_t03_2')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_end_point = carla.Transform(carla.Location(x=-5.941558, y=82.576515, z=0.275307), carla.Rotation(pitch=0.000000, yaw=89.637466, roll=0.000000))
        print(ts_end_point)
