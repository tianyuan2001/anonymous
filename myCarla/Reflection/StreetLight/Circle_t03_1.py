...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/StreetLight/Circle_t03_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=16.030827, y=10.789361, z=0.275307), carla.Rotation(pitch=0.000000, yaw=-58.797039, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=-20.467728, y=0.351503, z=0.275307), carla.Rotation(pitch=0.000000, yaw=81.806999, roll=0.000000))
        print(ts_end_point)
