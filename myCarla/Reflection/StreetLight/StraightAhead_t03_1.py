...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Reflection/StreetLight/StraightAhead_t03_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=52.776279, y=3.684685, z=0.275307), carla.Rotation(pitch=0.000000, yaw=0.855804, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=220.145645, y=6.308762, z=0.275307), carla.Rotation(pitch=0.000000, yaw=0.855804, roll=0.000000))
        print(ts_end_point)
