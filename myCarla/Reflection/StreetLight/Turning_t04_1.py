...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/StreetLight/Turning_t04_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=248.655090, y=-371.230103, z=0.281942), carla.Rotation(pitch=0.000000, yaw=-0.295319, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=389.563263, y=-224.724304, z=0.281942), carla.Rotation(pitch=0.000000, yaw=90.598579, roll=0.000000))
        print(ts_end_point)
