...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/Reflection/StreetLight/Bend_t06_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=108.234940, y=232.394485, z=0.624804), carla.Rotation(pitch=0.000000, yaw=-19.642578, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=251.056396, y=150.958191, z=0.300000), carla.Rotation(pitch=0.000000, yaw=0.234757, roll=0.000000))
