...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Shadow/Fence/StraightTurn_Below05_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-265.116394, y=-23.031763, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-89.583183, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=-162.537247, y=-84.638641, z=0.300000), carla.Rotation(pitch=0.000000, yaw=0.086304, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    os.system('python3 ../util/environment.py -alt 50 -azm 270')
