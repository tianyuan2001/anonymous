...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Shadow/Fence/StraightTurn_Below05_2')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-268.630066, y=-21.157270, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-89.583183, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=-115.980965, y=-138.739288, z=0.600000), carla.Rotation(pitch=0.000000, yaw=0.442562, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    os.system('python3 ../util/environment.py -alt 45 -azm 270')
    try:
        main()
    except KeyboardInterrupt:
        print('\nCancelled by user. Bye!')
