...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Shadow/Wire/Turning_Wire206_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=572.720825, y=241.221329, z=0.300000), carla.Rotation(pitch=0.000000, yaw=0.019546, roll=0.000000))
...
if __name__ == '__main__':
    ...
    client.load_world('Town06_wire2')
    ...
    # 原始场景
    client.load_world('Town06_wire2_origin')
    world = client.get_world() # 'Town'
    save_dir = args.output + "_origin"
    try:
        os.system('python3 ../util/environment.py -alt 55 -azm 0')
    except Exception:
        print('eeeeeeeeeeeeeeeeee----')
        exit()
    try:
