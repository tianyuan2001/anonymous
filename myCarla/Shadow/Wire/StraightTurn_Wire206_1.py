...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Shadow/Wire/StraightTurn_Wire206_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=150)
...
def main():
    ...
    try:
        ...
        # ts_start_point = carla.Transform(carla.Location(x=576.846191, y=141.792969, z=0.300000), carla.Rotation(pitch=0.000000, yaw=0.234757, roll=0.000000))
        ts_start_point = carla.Transform(carla.Location(x=600.846191, y=141.792969, z=0.300000), carla.Rotation(pitch=0.000000, yaw=0.234757, roll=0.000000))
        ...
        # ts_end_point = carla.Transform(carla.Location(x=661.172302, y=180.169189, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-89.378593, roll=0.000000))
        ts_end_point = carla.Transform(carla.Location(x=700.172302, y=141.792969, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-89.378593, roll=0.000000))
...
if __name__ == '__main__':
    ...
    save_dir = "/home/wanglu/Documents/carla_imgs/tmp"
    try:
        os.system('python3 ../util/environment.py -alt 42 -azm 0')
    except Exception:
        print('eeeeeeeeeeeeeeeeee----')
        exit()
