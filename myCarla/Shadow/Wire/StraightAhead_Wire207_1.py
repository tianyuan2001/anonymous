...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Shadow/Wire/StraightAhead_Wire207_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=79)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-90.358795, y=57.030289, z=0.500000), carla.Rotation(pitch=0.000000, yaw=3.264297, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=33.148777, y=63.709240, z=0.300000), carla.Rotation(pitch=0.000000, yaw=1.677201, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    client.load_world('Town07_wire2')
    ...
    try:
        os.system('python3 ../util/environment.py -alt 45 -azm 0')
    except Exception:
        print('eeeeeeeeeeeeeeeeee----')
        exit()
    try:
