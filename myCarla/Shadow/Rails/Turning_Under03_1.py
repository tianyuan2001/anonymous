...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Shadow/Rails/Turning_Under03_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=150)
...
if __name__ == '__main__':
    ...
    save_dir = args.output + "_alt50azm70"
    try:
        os.system('python3 ../util/environment.py -alt 50 -azm 70')    # 阴影在正下方
    except Exception:
    ...
    try:
        os.system('python3 ../util/environment.py -alt 30 -azm 150')
    except Exception:
        print('eeeeeeeeeeeeeeeeee----')
        exit()
