...
# 地图：Town03_high_rails
# 起止点：右2车道 158 -> 197，右1车道 159 -> 198

'''
右2车道 158 -> 197
Transform(Location(x=-20.033100, y=204.005676, z=0.275307), Rotation(pitch=0.000000, yaw=-0.142975, roll=0.000000))

右1车道 159 -> 198
Transform(Location(x=-11.424367, y=207.505676, z=0.275307), Rotation(pitch=0.000000, yaw=-0.142975, roll=0.000000))
'''
...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Shadow/Rails/StraightAhead_Aside03_2')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=99)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-20.033100, y=204.005676, z=0.275307), carla.Rotation(pitch=0.000000, yaw=-0.142975, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=239.203339, y=115.793488, z=0.952807), carla.Rotation(pitch=0.000000, yaw=-88.605339, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    try:
        os.system('python3 ../util/environment.py -alt 30 -azm 0')
    except Exception:
        print('eeeeeeeeeeeeeeeeee----')
        exit()
