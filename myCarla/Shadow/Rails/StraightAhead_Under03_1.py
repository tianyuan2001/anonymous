...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Shadow/Rails/StraightAhead_Under03_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=49)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-149.010956, y=5.159778, z=0.409923), carla.Rotation(pitch=0.000000, yaw=90.029823, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=-149.063583, y=107.705582, z=0.275307), carla.Rotation(pitch=0.000000, yaw=89.622032, roll=0.000000))
        print(ts_end_point)
