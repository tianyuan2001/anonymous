...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Shadow/Rails/Uphill_Aside05_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=79)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=26.419664, y=-207.565033, z=0.300000), carla.Rotation(pitch=0.000000, yaw=179.757080, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=37.302151, y=208.752197, z=0.300000), carla.Rotation(pitch=0.000000, yaw=0.287814, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    try:
        os.system('python3 ../util/environment.py -alt 30 -azm 180')
    except Exception:
        print('eeeeeeeeeeeeeeeeee----')
        exit()
    try:
