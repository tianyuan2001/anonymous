...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Shadow/Rails/StraightAhead_Aside03_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=49)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-11.424367, y=207.505676, z=0.275307), carla.Rotation(pitch=0.000000, yaw=-0.142975, roll=0.000000))
