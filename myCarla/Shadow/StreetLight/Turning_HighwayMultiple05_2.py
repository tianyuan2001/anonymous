...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Shadow/StreetLight/Turning_HighwayMultiple05_2')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=300)
...
if __name__ == '__main__':
    ...
    try:
        os.system('python3 ../util/environment.py -alt 20 -azm 120')
    except Exception:
        print('eeeeeeeeeeeeeeeeee----')
        exit()
    try:
