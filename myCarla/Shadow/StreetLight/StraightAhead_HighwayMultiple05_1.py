...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Shadow/StreetLight/StraightAhead_HighwayMultiple05_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=49)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=203.739853, y=-11.190423, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-90.669060, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=69.371284, y=-200.747086, z=0.300000), carla.Rotation(pitch=0.000000, yaw=179.757080, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    try:
        os.system('python3 ../util/environment.py -alt 20 -azm 270')
    except Exception:
        print('eeeeeeeeeeeeeeeeee----')
        exit()
    try:
