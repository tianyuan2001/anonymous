...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Shadow/StreetLight/Turning_HighwayMultiple05_3')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=300)
...
def main():
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=69.400948, y=-193.747147, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-0.242950, roll=0.000000))
        ...
        ts_end_point = carla.Transform(carla.Location(x=196.740326, y=-11.108692, z=0.300000), carla.Rotation(pitch=0.000000, yaw=89.330902, roll=0.000000))
        print(ts_end_point)
...
# alt 13 azm 260
    save_dir = args.output + "_alt13azm260"
    try:
        os.system('python3 ../util/environment.py -alt 13 -azm 260')    # 阴影
    except Exception:
    ...
    try:
        os.system('python3 ../util/environment.py -alt 30 -azm 90')
    except Exception:
        print('eeeeeeeeeeeeeeeeee----')
        exit()
    try:
