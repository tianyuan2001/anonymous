...
def parse_arg():
    ...
    argparser.add_argument(
        '--output', '-o',
        type=str,
        default='/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark/Shadow/StreetLight/StraightAhead_HighwaySimple03_1')
    argparser.add_argument(
        '--img_num', '-n',
        type=int,
        default=49)
...
if __name__ == '__main__':
    ...
    try:
        os.system('python3 ../util/environment.py -alt 18 -azm 5')
    except Exception:
        print('eeeeeeeeeeeeeeeeee----')
        exit()
    try:
