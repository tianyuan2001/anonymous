...
def main(save_dir):
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-128.284348, y=-58.789974, z=0.300000), carla.Rotation(pitch=0.000000, yaw=90.393547, roll=0.000000))
        print(ts_start_point)
        #ts_end_point = spawn_points[end_index]
        ts_end_point = carla.Transform(carla.Location(x=-124.911293, y=-40.291382, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-89.606445, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    output = '/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/TrafficParticipants/Vehicles/t05_1'
