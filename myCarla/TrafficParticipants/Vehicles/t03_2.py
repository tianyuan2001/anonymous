...
def main(save_dir):
    ...
    try:
        ...
        ts_end_point = carla.Transform(carla.Location(x=5.430785, y=122.276344, z=0.275307), carla.Rotation(pitch=0.000000, yaw=-90.362541, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    output = '/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/TrafficParticipants/Vehicles/t03_2'
