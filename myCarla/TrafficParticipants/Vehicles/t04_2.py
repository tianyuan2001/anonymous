...
def main(save_dir):
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=54.101269, y=-173.848663, z=0.600000), carla.Rotation(pitch=0.000000, yaw=-179.673874, roll=0.000000))
        print(ts_start_point)
        #ts_end_point = spawn_points[end_index]
        ts_end_point = carla.Transform(carla.Location(x=24.118235, y=-289.029419, z=0.281942), carla.Rotation(pitch=0.000000, yaw=-63.645340, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    output = '/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/TrafficParticipants/Vehicles/t04_2'
