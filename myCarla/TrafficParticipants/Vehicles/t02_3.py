...
def main(save_dir):
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=131.690033, y=105.549965, z=0.500000), carla.Rotation(pitch=0.000000, yaw=-179.999634, roll=0.000000))
        print(ts_start_point)
        #ts_end_point = spawn_points[end_index]
        ts_end_point = carla.Transform(carla.Location(x=1.540024, y=105.549988, z=0.500000), carla.Rotation(pitch=0.000000, yaw=-179.999634, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    output = '/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/TrafficParticipants/Vehicles/t02_3'
