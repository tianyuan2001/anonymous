...
def main(save_dir):
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=200.934738, y=-392.309052, z=0.281942), carla.Rotation(pitch=0.000000, yaw=-179.570084, roll=0.000000))
        print(ts_start_point)
        #ts_end_point = spawn_points[end_index]
        ts_end_point = carla.Transform(carla.Location(x=-27.568939, y=-248.363358, z=0.281942), carla.Rotation(pitch=0.000000, yaw=123.945671, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    output = '/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/TrafficParticipants/Vehicles/t04_3'
