...
def main(save_dir):
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=88.619987, y=111.189240, z=0.300000), carla.Rotation(pitch=0.000000, yaw=90.000046, roll=0.000000))
        print(ts_start_point)
        #ts_end_point = spawn_points[end_index]
        ts_end_point = carla.Transform(carla.Location(x=88.619980, y=226.905640, z=0.300000), carla.Rotation(pitch=0.000000, yaw=90.000046, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    output = '/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/TrafficParticipants/Vehicles/t01_3'
