...
def main(save_dir):
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-230.694168, y=-18.640121, z=0.300000), carla.Rotation(pitch=0.000000, yaw=179.481918, roll=0.000000))
        print(ts_start_point)
        #ts_end_point = spawn_points[end_index]
        ts_end_point = carla.Transform(carla.Location(x=-338.737915, y=240.881241, z=0.300000), carla.Rotation(pitch=0.000000, yaw=21.970900, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    output = '/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/TrafficParticipants/Vehicles/t06_1'
