...
def main(save_dir):
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=-104.160065, y=62.580990, z=0.500000), carla.Rotation(pitch=1.189095, yaw=94.720673, roll=0.000000))
        print(ts_start_point)
        #ts_end_point = spawn_points[end_index]
        ts_end_point = carla.Transform(carla.Location(x=-184.496170, y=107.221306, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-173.872543, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    output = '/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/TrafficParticipants/Vehicles/t07_1'
