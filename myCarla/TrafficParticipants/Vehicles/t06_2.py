...
def main(save_dir):
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=504.310394, y=31.871843, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-33.650711, roll=0.000000))
        print(ts_start_point)
        #ts_end_point = spawn_points[end_index]
        ts_end_point = carla.Transform(carla.Location(x=446.037750, y=-14.061425, z=0.300000), carla.Rotation(pitch=0.000000, yaw=179.791321, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    output = '/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/TrafficParticipants/Vehicles/t06_2'
