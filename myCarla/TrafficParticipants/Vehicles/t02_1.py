...
def main(save_dir):
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=92.340050, y=187.919998, z=0.500000), carla.Rotation(pitch=0.000000, yaw=-179.999634, roll=0.000000))
        print(ts_start_point)
        #ts_end_point = spawn_points[end_index]
        ts_end_point = carla.Transform(carla.Location(x=92.340019, y=191.769989, z=0.500000), carla.Rotation(pitch=0.000000, yaw=-0.000183, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    output = '/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/TrafficParticipants/Vehicles/t02_1'
