...
def main(save_dir):
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=451.420685, y=148.398499, z=0.300000), carla.Rotation(pitch=0.000000, yaw=0.234757, roll=0.000000))
        print(ts_start_point)
        #ts_end_point = spawn_points[end_index]
        ts_end_point = carla.Transform(carla.Location(x=606.858032, y=145.415970, z=0.300000), carla.Rotation(pitch=0.000000, yaw=0.234757, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    output = '/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/TrafficParticipants/Vehicles/t06_3'
