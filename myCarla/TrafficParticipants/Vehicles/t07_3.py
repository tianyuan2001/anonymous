...
def main(save_dir):
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=48.051220, y=60.210747, z=0.300000), carla.Rotation(pitch=0.000000, yaw=-178.322815, roll=0.000000))
...
if __name__ == '__main__':
    ...
    output = '/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/TrafficParticipants/Vehicles/t07_3'
