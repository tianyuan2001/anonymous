...
def main(save_dir):
    ...
    try:
        ...
        ts_start_point = carla.Transform(carla.Location(x=194.094452, y=-248.690353, z=0.800000), carla.Rotation(pitch=0.000000, yaw=178.404694, roll=0.000000))
        print(ts_start_point)
        #ts_end_point = spawn_points[end_index]
        ts_end_point = carla.Transform(carla.Location(x=104.937027, y=-173.559296, z=0.600000), carla.Rotation(pitch=0.000000, yaw=-179.673874, roll=0.000000))
        print(ts_end_point)
...
if __name__ == '__main__':
    ...
    output = '/media/wanglu/MyPassport/Carla-Images/lane-detection-benchmark-1/TrafficParticipants/Vehicles/t04_1'
